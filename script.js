/* ============================================================
   ...
   Isolated 3D hero scene ONLY. This is the one part of the page that 
   depends on WebGL + ES module imports.
   ============================================================ */
try {
...
function initHeroScene(THREE, EffectComposer, RenderPass, UnrealBloomPass) {
  ...
  const ballGeo = new THREE.SphereGeometry(1.25, 128, 128);
  ...
  for (let i = 0; i < 5; i++) {
    ...
    const beamMat = new THREE.MeshBasicMaterial({
      color: i % 2 === 0 ? 0x1e90ff : 0xff6a00, transparent: true, opacity: 0.06,
